...
from datasets_augs import * # augmention random H/V flisp A,B together
...
os.makedirs("/home/local/AD/cordun1/experiments/TFC-GAN-STN/images/test_results/%s_FLIPPED" % opt.experiment, exist_ok=True)
...
for i, batch in tqdm(enumerate(test_dataloader)):
    ...
    save_image(img_sample_global, "images/test_results/%s_FLIPPED/%s.png" % (opt.experiment, i), nrow=4, normalize=True)

...
def main(fake_dir, real_dir, experiment, test_set):
    ...
    # Return average
    print("--------------Experiment: {} | Average MSE of Magnitude Spectra: [ {} ]-------------".format(experiment, mse_values_.mean()))
    ...
    mse_table.to_csv('/home/local/AD/cordun1/experiments/TFC-GAN/evaluation/Eurecom/%s/mse_spec.csv' % (experiment))

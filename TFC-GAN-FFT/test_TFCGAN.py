...
for i, batch in tqdm(enumerate(test_dataloader)):
    ...
    """
    # SAVE PATCHES
    img_sample1 = torch.cat((fake_B1.data, B1.data), -2)
    img_sample2 = torch.cat((fake_B2.data, B2.data), -2)
    img_sample3 = torch.cat((fake_B3.data, B3.data), -2)
    img_sample4 = torch.cat((fake_B4.data, B4.data), -2)
    ...
    # Later, add the magnitude spectra

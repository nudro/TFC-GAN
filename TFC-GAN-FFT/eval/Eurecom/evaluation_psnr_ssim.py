...
def main(fake_dir, real_dir, experiment):
    ...
    psnr_table.to_csv('/Users/catherine/Documents/GANs_Research/my_imps/research_models/faPVTgan/evaluation/Eurecom/%s/psnr.csv' % (experiment))
    ...
    ssim_table.to_csv('/Users/catherine/Documents/GANs_Research/my_imps/research_models/faPVTgan/evaluation/Eurecom/%s/ssim.csv' % (experiment))

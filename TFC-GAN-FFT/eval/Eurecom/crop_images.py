    ...
    for item in dirs:
        ...
        if os.path.isfile(fullpath):
            ...
            if model=='custom':            # do the cropping
                ...
                realB_source = "/Users/catherine/Documents/GANs_Research/my_imps/research_models/faPVTgan/evaluation/Eurecom/pix2pix_Eur/real_B/"
                destination = "/Users/catherine/Documents/GANs_Research/my_imps/research_models/faPVTgan/evaluation/Eurecom/%s/real_B/" % experiment
...
if __name__ == '__main__':
    ...
    os.makedirs("/Users/catherine/Documents/GANs_Research/my_imps/research_models/faPVTgan/evaluation/Eurecom/%s/fake_B" % opt.experiment, exist_ok=True)
    os.makedirs("/Users/catherine/Documents/GANs_Research/my_imps/research_models/faPVTgan/evaluation/Eurecom/%s/real_B" % opt.experiment, exist_ok=True)
    os.makedirs("/Users/catherine/Documents/GANs_Research/my_imps/research_models/faPVTgan/evaluation/Eurecom/%s/real_A" % opt.experiment, exist_ok=True)

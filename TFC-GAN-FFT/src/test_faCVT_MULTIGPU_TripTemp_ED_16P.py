...
for i, batch in tqdm(enumerate(test_dataloader)):
    ...
    # SAVE PATCHES
    img_sample1 = torch.cat((fake_B1.data, B1.data, fake_B2.data, B2.data, fake_B3.data, B3.data, fake_B4.data, B4.data), -2)
    img_sample2 = torch.cat((fake_B5.data, B5.data, fake_B6.data, B6.data, fake_B7.data, B7.data, fake_B8.data, B8.data), -2)
    img_sample3 = torch.cat((fake_B9.data, B9.data, fake_B10.data, B10.data, fake_B11.data, B11.data, fake_B12.data, B12.data), -2)
    img_sample4 = torch.cat((fake_B13.data, B13.data, fake_B14.data, B14.data, fake_B15.data, B15.data, fake_B16.data, B16.data), -2)

    img_sample_patch = torch.cat((img_sample1.data, img_sample2.data, img_sample3.data, img_sample4.data), -2) #0 or -2? dim

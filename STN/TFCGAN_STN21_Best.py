...
#criterion_ssim = kornia.losses.SSIMLoss(5)
...
for epoch in range(opt.epoch, opt.n_epochs):
    for i, batch in enumerate(dataloader):
        ...
        with autocast(): 
            ...
            # ssim
            #ssim_loss = morph_ssim(fake_B, warped_B) # <--- changed to make the warped match the siim of the fake
            ...
            #loss_G = loss_GAN + perc_loss + ssim_loss
